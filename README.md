...
The 'healthclaim_guardian' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/healthclaim_guardian/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] healthclaim_guardian_etl` to your workspace.
